...
//------------------------------------------------------------------------------
// VRInterface(const VRInterface &plot)
//------------------------------------------------------------------------------
/**
 * The copy constructor
 */
 //------------------------------------------------------------------------------
VRInterface::VRInterface(const VRInterface &plot)
	: Subscriber(plot)
{
...
//------------------------------------------------------------------------------
// VRInterface& operator=(const VRInterface &plot)
//------------------------------------------------------------------------------
/**
 * The assignment operator
 */
 //------------------------------------------------------------------------------
VRInterface& VRInterface::operator=(const VRInterface& plot)
{
	if (this == &plot)
		return *this;
...
bool VRInterface::GetShowObject(const std::string &name)
{
	...
	("VRInterface::GetShowObject() name=%s returning %d\n",
...
#if DBGLVL_PARAM
	MessageInterface::ShowMessage
	("VRInterface::SetShowObject() name=%s setting %d\n", name.c_str(), value);
#endif
...
bool VRInterface::Activate(bool state)
{
	...
	MessageInterface::ShowMessage
	("VRInterface::Activate() this=<%p>'%s' entered, state=%d, isInitialized=%d\n",
...
#if DBGLVL_INIT
	MessageInterface::ShowMessage
	("VRInterface::Initialize() this=<%p>'%s', active=%d, isInitialized=%d, "
...
#if DBGLVL_INIT > 1
		MessageInterface::ShowMessage
		("VRInterface::Initialize() mAllSpNameArray[%d]=<%p>'%s'\n",
...
#if DBGLVL_INIT
	MessageInterface::ShowMessage
	("VRInterface::Initialize() Building color maps\n");
#endif
	for (int i = 0; i < mAllSpCount; i++)
	{
...
#if DBGLVL_INIT > 1
			MessageInterface::ShowMessage
			("VRInterface::Initialize() orbitColor=%06X, targetColor=%06X\n",
...
#if DBGLVL_INIT
	MessageInterface::ShowMessage("VRInterface::Initialize() exiting\n");
#endif
...
#if DBGLVL_RENAME
	MessageInterface::ShowMessage
	("VRInterface::SetName() newName=%s, oldName=%s\n", who.c_str(),
		oldName.c_str());
#endif
...
#if DBGLVL_RENAME
	MessageInterface::ShowMessage
	("\nVRInterface::RenameRefObject() '%s' entered, type=%s, oldName=%s, newName=%s, "
...
#if DBGLVL_RENAME
	MessageInterface::ShowMessage
	("VRInterface::RenameRefObject() '%s' returning true\n", GetName().c_str());
#endif
	return true;
}
...
std::string VRInterface::GetStringParameter(const Integer id) const
{
	...
	MessageInterface::ShowMessage("VRInterface::GetStringParameter() id = %d\n", id);
#endif
	...
	{
#if DBGLVL_PARAM_STRING
		MessageInterface::ShowMessage("VRInterface::GetStringParameter() Calling GetObjectStringList()\n");
#endif
...
#if DBGLVL_PARAM_STRING
	MessageInterface::ShowMessage
	("VRInterface::GetStringParameter() label = %s\n", label.c_str());
#endif
...
#if DBGLVL_PARAM_STRING
	MessageInterface::ShowMessage
	("VRInterface::SetStringParameter() this=<%p>'%s', id=%d<%s>, value='%s'\n",
...
#if DBGLVL_PARAM_STRING
	MessageInterface::ShowMessage
	("VRInterface::SetStringParameter()<%s> label=%s, value=%s \n",
...
#if DBGLVL_PARAM_STRING
	MessageInterface::ShowMessage
	("VRInterface::SetStringParameter()<%s> id=%d<%s>, value=%s, index= %d\n",
...
#if DBGLVL_PARAM_STRING
	MessageInterface::ShowMessage
	("VRInterface::SetStringParameter() label = %s, value = %s, index = %d\n",
...
#if DBGLVL_PARAM
	MessageInterface::ShowMessage
	("VRInterface::SetBooleanParameter()<%s> id=%d, value=%d\n",
...
#if DBGLVL_PARAM
	MessageInterface::ShowMessage
	("VRInterface::SetBooleanArrayParameter() '%s' entered, id=%d, "
...
#ifdef DBGLVL_OBJ
	MessageInterface::ShowMessage
	("VRInterface::GetRefObjectNameArray() '%s' entered, refObjectNames.size()=%d, "
...
#if DBGLVL_OBJ
	MessageInterface::ShowMessage
	("VRInterface::GetRefObjectNameArray() returning %d names for type:%d typeName:%s\n",
...
#if DBGLVL_OBJ
	MessageInterface::ShowMessage
	("VRInterface::SetRefObject() this=<%p>'%s' entered, obj=<%p><%s>'%s', type=%d, "
...
#if DBGLVL_OBJ
		MessageInterface::ShowMessage
		("VRInterface::SetRefObject() this=<%p>'%s' returning false, object is NULL\n",
			this, GetName().c_str());
#endif
		return false;
	}
...
#if DBGLVL_OBJ > 1
		MessageInterface::ShowMessage
		("VRInterface::SetRefObject() this=<%p>'%s' returning true\n",
			this, GetName().c_str());
#endif
		return true;
	}
...
#if DBGLVL_OBJ > 1
	MessageInterface::ShowMessage
	("VRInterface::SetRefObject() this=<%p>'%s' returning Subscriber::SetRefObject()\n",
		this, GetName().c_str());
#endif
...
#ifdef DEBUG_COLOR
	MessageInterface::ShowMessage
	("VRInterface::SetOrbitColorChanged() entered, newColor = '%s', objName = '%s', "
...
#ifdef DEBUG_COLOR
	MessageInterface::ShowMessage
	("VRInterface::HandleTargetColorChanged() leaving, new intColor = %06X\n", intColor);
#endif
}
...
#ifdef DEBUG_COLOR
	MessageInterface::ShowMessage
	("VRInterface::SetTargetColorChanged() entered, newColor='%s', objName='%s', "
		"desc='%s'\n", newColor.c_str(), objName.c_str(), desc.c_str());
#endif
...
#ifdef DEBUG_COLOR
	MessageInterface::ShowMessage
	("VRInterface::SetTargetColorChanged() leaving, new intColor = %06X\n", intColor);
#endif
}
	...
	UnsignedInt orbitColor, const StringArray &objNames)
{
#ifdef DEBUG_COLOR
	MessageInterface::ShowMessage
	("VRInterface::SetSegmentOrbitColor() '%s' entered, originator=<%p>, "
	...
	MessageInterface::ShowMessage
	("VRInterface::SetSegmentOrbitColor() '%s' leaving\n", GetName().c_str());
#endif
}
...
bool VRInterface::AddSpacePoint(const std::string &name, Integer index, bool show)
{
#if DBGLVL_ADD
	MessageInterface::ShowMessage
	("VRInterface::AddSpacePoint()<%s> name=%s, index=%d, show=%d, mAllSpCount=%d\n",
	...
	MessageInterface::ShowMessage
	("VRInterface::AddSpacePoint()<%s> leaving, name=%s\n", instanceName.c_str(), name.c_str());
#endif
...
#if DBGLVL_REMOVE_SP
	MessageInterface::ShowMessage
	("VRInterface::RemoveSpacePoint() name=%s\n--- Before remove from "
		"mScNameArray:\n", name.c_str());
...
#if DBGLVL_INIT
	MessageInterface::ShowMessage
	("VRInterface::BuildDynamicArrays() entered, mAllSpNameArray.size()=%d, "
...
#if DBGLVL_INIT
	MessageInterface::ShowMessage("VRInterface::BuildDynamicArrays() leaving\n");
#endif
}
...
void VRInterface::UpdateObjectList(SpacePoint *sp, bool show)
{
#if DBGLVL_INIT > 1
	MessageInterface::ShowMessage
	("VRInterface::UpdateObjectList() <%p>'%s' entered, sp=<%p>'%s', show=%d\n",
	...
	MessageInterface::ShowMessage
	("VRInterface::UpdateObjectList() <%p>'%s' leaving\n", this, instanceName.c_str());
#endif
}
...
#ifdef DEBUG_FUNCTION_DATA
			MessageInterface::ShowMessage
			("VRInterface::Update() this=<%p>'%s' just returning true\n   data is "
...
#if DBGLVL_UPDATE > 1
	MessageInterface::ShowMessage
	("\nVRInterface::UpdateData() entered, mNumData=%d, mDataCollectFrequency=%d, "
...
#if DBGLVL_UPDATE > 1
	MessageInterface::ShowMessage("VRInterface::UpdateData() returning true\n");
#endif
	return true;
}
...
//------------------------------------------------------------------------------
bool VRInterface::UpdateSolverData()
{
...
#if DBGLVL_DATA
	MessageInterface::ShowMessage
	("===> VRInterface::BufferPreviousData() setting to previous data\n   scIndex=%d, "
...
#if DBGLVL_DATA
	MessageInterface::ShowMessage
	("VRInterface::BufferOrbitData() <%p>'%s' entered, len=%d, epoch=%.12f, mNumData=%d\n",
	...
	Real currEpoch)
{
	...
	MessageInterface::ShowMessage
	("=> VRInterface::HandleAbsentData() entered, scName='%s', scIndex=%d, "
...
#ifdef DEBUG_ABSENT_DATA
	MessageInterface::ShowMessage
	("VRInterface::HandleAbsentData() leaving, scName='%s', scIndex=%d, "
		"currEpoch=%.12f\n", scName.c_str(), scIndex, currEpoch);
#endif
}
